...
<html>
  <head>
    <title>L'éco-conception tester</title>
  ...
  <div id="bloc" class="headline" >
    ...
    <div class="eco-image intro" >
     ...
     <!--part6 vidéo YT-->  
    <div class="videoYT">
      <div class="textvideo">Retrouver dans cette vidéo l’explication de l'éco-conception selon une agence qui la pratique lors de toute ses conceptions.</div>
      <div class="imagevidéo"><iframe width="560" height="315" src="https://www.youtube.com/embed/790WTNgg-78" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe> </div>  
       
    </div >  

     <!--part6 conclusion renvoi vers les bonnes pratiques-->
    <div class="conclusion">
       <span class="fin"><div class="textconclusion">Et vous ? Avez-vous déjà réfléchi à l’empreinte écologique de votre site web ? </div></span>
       <div class="textconclusion"  >Dans le numérique, comme dans d’autres secteurs, la tendance est au vert. De plus en plus d’entreprises se mettent à l’éco-conception web et cherchent à trouver le bon compromis entre performance et impact environnemental.Dans la page suivante, nous passons au crible l’éco-conception web et ses bonnes pratiques. Découvrez quelles sont les bonnes pratiques, simples à mettre en place rendre votre site Internet moins gourmand en ressources énergétiques.
       </div></span>
